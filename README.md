# Pipeline для отслеживания остатков на маркетплейсе с использованием Apache Airflow и ClickHouse

### Описание проекта

Проект представляет собой автоматизированный пайплайн, разработанный с использованием Apache Airflow, для сбора, хранения и анализа данных об остатках товаров на маркетплейсе. Данные получаются путем парсинга и сохраняются в базе данных. На основе изменений остатков строится витрина данных для анализа динамики продаж.

## Функциональность

# 1. Сбор данных об остатках товаров

- Парсинг информации об остатках 10 товаров по их артикулам.

- Использование API маркетплейса для получения данных.

- Регулярный сбор данных ежедневно в 23:00 (МСК).

# 2. Хранение данных

- Запись изменений остатков в базу данных.

- Структура таблицы: date, nmId, stocks.

# 3. Анализ динамики продаж

- Определение продаж как изменения остатков.

- Формирование витрины данных date, nmId, orders.

# 4. Развертывание инфраструктуры

- Использование VPS-сервера в Yandex Cloud (Ubuntu).

- Развертывание сервисов Apache Airflow и ClickHouse с помощью docker-compose.
